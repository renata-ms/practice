...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'library_book', (
            ...
            ('publication_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 8, 0, 0))),
        ))
        ...
        db.create_table(u'library_bookimage', (
            ...
            ('fkey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['library.Book'])),
    ...
    models = {
        ...
        u'library.bookimage': {
            ...
            'fkey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['library.Book']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
